...
//(a.) Calculate the average rating for all restaurants
...
console.log(
  "The AverageRating of All the Restaurants is:",
  averageRatingsArray
);

// (b.) Filter restaurants with an average rating greater than or equal to 4
const highRatedRestaurants = averageRatingsArray.filter(
  ({ averageRating }) => averageRating >= 4
);

console.log(
  " All the Restaurants with an AverageRating greater than or equal to 4 i:",
